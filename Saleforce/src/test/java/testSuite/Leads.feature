#Author: devathukeerthana@gmail.com
@Leads
...
Scenario: Click New Lead
  ...
  Scenario Outline: Save Lead  by filling the form
    ...
    Examples: 
      ...
      | Keerthana   | Sathish     | V | Mr.        | rampwave.org.in | jr     | IBM     | devathukeerthana@gmail.com |  9494959756 | Banking  | Website    |
  ...
  Scenario Outline: WebtoLead
    ...
    Examples: 
      ...
      | Mr.        | Sreenivas    | d | keerthi@gmail.com | 9553109052 | Warangal | Telangana | IBM     |
