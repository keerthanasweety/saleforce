...
public class WebtoLead extends Base
{
	...
	public Boolean Fillform(String firstName ,String lastname,String salutation ,String phone,String email,String city,String state,String company)
	{
		try
		{
		...
		wait.until(ExpectedConditions.visibilityOf(Elements_Leads.firstname)).sendKeys(firstName);
		wait.until(ExpectedConditions.visibilityOf(Elements_Leads.wllastname)).sendKeys(lastname);
